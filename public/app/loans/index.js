...
function initDatatable() {
    const dtLoans = renderDatatable(
        '#dtLoans',
        '/api/datatables/loans',
        [
            {
    ...
    setDatatableLengthField(dtLoans, $('#dtLoans').parents('.dt-container').find('.dt-length'))
    setDatatableFilterField(dtLoans, $('#dtLoans').parents('.dt-container').find('.dt-search'))
    setDatatablePrintButton(dtLoans, $('#dtLoans').parents('.dt-container').find('.dt-print'))
    setDatatableExcelButton(dtLoans, $('#dtLoans').parents('.dt-container').find('.dt-excel'))
    setDatatablePdfButton(dtLoans, $('#dtLoans').parents('.dt-container').find('.dt-pdf'))
